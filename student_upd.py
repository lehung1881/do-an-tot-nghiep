...
class Student:
    def __init__(self,root):
        ...
        img3 = PIL.Image.open(r"ImageFaceDetect\bg_new_2.png")
        ...
        dep_combo["values"]=("Chọn chuyên ngành", "Du lịch", "Công nghệ thông tin", "Cơ khí", "Điện", "Kế toán", "Tự động hóa")
        dep_combo.current(0)
        ...
        course_combo["values"] = ("Chọn hệ", "Chính quy", "Liên Thông", "Chất lương cao")
        ...
        year_combo = ttk.Combobox(current_course_frame,textvariable=self.var_year, font=("times new roman", 13, "bold"), state="readonly",
                                    width=20)
        year_combo["values"] = ("Chọn năm học", "2020-2021", "2021-2022", "2022-2023", "2023-2024")
        ...
        radionbtn1 = ttk.Radiobutton(class_student_frame, variable=self.var_radio1, text="Đã train", value="Yes")
        radionbtn1.grid(row=6, column=0)


        radionbtn2 = ttk.Radiobutton(class_student_frame,variable=self.var_radio1, text="Chưa train", value="No")
    ...
    def train_classifier(self):
        try:
            train_x, train_y = load_dataset('./images/')
            ...
            messagebox.showinfo("Thông báo", "Traning thành công!", parent=self.root)
        except:
            messagebox.showinfo("Thông báo", "Dữ liệu đã train hết!", parent=self.root)
