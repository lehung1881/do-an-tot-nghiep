...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        heading = Label(bg_img, text="SINH VIÊN ĐIỂM DANH", font=("yu gothic ui", 20, "bold"), bg="white",
                        fg="red2",
                        bd=0, relief=FLAT)
        ...
        self.img_right = PIL.Image.open(r"ImageFaceDetect\unknown4.PNG")
    ...
    def face_recog(self):
            ...
            def draw_boundray(img, classifier):
